...
{
    [NodeMenuDisplay("Tweens/Transform/Spiral")]
    public class SpiralVertex : TweenVertex
    {
        [SerializeField]
        private Connection _axisCnx, _modeCnx, _freqCnx, _speedCnx, _depthCnx, _snapCnx;
