...
{
    [NodeMenuDisplay("Tweens/UI/Rect Transform/Punch Anchor Position")]
    public class RTransPunchAnchorPosVertex : TweenVertex
    {
        [SerializeField]
        ...
        public override Tween GenerateTween()
        {
            ...
            Vector2 punch = _punchCnx == null ? _value : ((ValueVertex<Vector2>)_punchCnx.TargetCnx).Value;
            ...
            Tween tween = target
                .DOPunchAnchorPos(punch, duration, vibrato, elasticity, snapping)
                .SetDelay(delay)
                .SetAutoKill(false);
