...
{
    [NodeMenuDisplay("Tweens/UI/Rect Transform/Anchor Max")]
    public class RTransAnchorMaxVertex : TweenVertex
    {
        [SerializeField]
        ...
        public override Tween GenerateTween()
        {
            ...
            Tween tween = target
                .DOAnchorMax(end, duration, snapping)
                .From(start)
                .SetDelay(delay)
                .SetAutoKill(false);
            SetEase(tween);
