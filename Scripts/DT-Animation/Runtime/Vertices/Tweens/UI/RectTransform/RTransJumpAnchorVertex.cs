...
{
    [NodeMenuDisplay("Tweens/UI/Rect Transform/Anchor Jump")]
    public class RTransJumpAnchorVertex : TweenVertex
    {
        [SerializeField]
        ...
        public override Tween GenerateTween()
        {
            ...
            float jumpPower = _powerCnx == null ? 0f : ((ValueVertex<float>)_powerCnx.TargetCnx).Value;
