...
{
    [NodeMenuDisplay("Tweens/UI/Rect Transform/Anchor Min")]
    public class RTransAnchorMinVertex : TweenVertex
    {
        [SerializeField]
        ...
        public override Tween GenerateTween()
        {
            ...
            Tween tween = target
                .DOAnchorMin(end, duration, snapping)
                .From(start)
                .SetDelay(delay)
                .SetAutoKill(false);
