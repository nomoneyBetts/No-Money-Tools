...
{
    [NodeMenuDisplay("Tweens/UI/Rect Transform/Anchor Position 3D")]
    public class RTransAnchorPos3DVertex : TweenVertex
    {
        [SerializeField]
        ...
        public override Tween GenerateTween()
        {
            ...
            _value = target.anchoredPosition3D;
            ...
            Tween tween = target
                .DOAnchorPos3D(end, duration, snapping)
                .From(start)
                .SetDelay(delay)
                .SetAutoKill(false);
        ...
        {
            RectTransform target = GetTarget<RectTransform>(DefaultTarget);
            target.anchoredPosition3D = _value;
        }
    }
}
