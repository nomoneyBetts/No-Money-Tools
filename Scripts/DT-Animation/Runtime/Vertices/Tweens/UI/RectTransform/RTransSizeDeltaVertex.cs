...
{
    [NodeMenuDisplay("Tweens/UI/Rect Transform/Size Delta")]
    public class RTransSizeDeltaVertex : TweenVertex
    {
        [SerializeField]
        ...
        public override Tween GenerateTween()
        {
            ...
            Tween tween = target
                .DOSizeDelta(end, duration, snapping)
                .From(start)
                .SetDelay(delay)
                .SetAutoKill(false);
