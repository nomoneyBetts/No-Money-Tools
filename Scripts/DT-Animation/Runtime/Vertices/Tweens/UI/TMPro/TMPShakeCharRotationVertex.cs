...
{
    [NodeMenuDisplay("Tweens/UI/TMPro/Shake Char Rotation")]
    public class TMPShakeCharRotationVertex : TweenVertex
    {
        [SerializeField]
        ...
        public override Tween GenerateTween()
        {
            ...
            Vector3 shake = _shakeCnx == null ? Vector3.zero : ((ValueVertex<Vector3>)_shakeCnx.TargetCnx).Value;
            ...
            Tween tween = vw.Wrapper
                .DOShakeCharRotation(index, duration, shake, vibrato, randomness, fadeOut)
                .SetDelay(delay)
                .SetAutoKill(false);
