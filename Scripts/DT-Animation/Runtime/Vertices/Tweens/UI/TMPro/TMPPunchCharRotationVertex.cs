...
{
    [NodeMenuDisplay("Tweens/UI/TMPro/Punch Char Rotation")]
    public class TMPPunchCharRotationVertex : TweenVertex
    {
        [SerializeField]
        ...
        public override Tween GenerateTween()
        {
            ...
            Tween tween = vw.Wrapper
                .DOPunchCharRotation(index, punch, duration, vibrato, elasticity)
                .SetDelay(delay)
                .SetAutoKill(false);
