...
{
    [NodeMenuDisplay("Tweens/UI/TMPro/Punch Char Offset")]
    public class TMPPunchCharOffsetVertex : TweenVertex
    {
        [SerializeField]
        ...
        public override Tween GenerateTween()
        {
            ...
            Tween tween = vw.Wrapper
                .DOPunchCharOffset(index, punch, duration, vibrato, elasticity)
                .SetDelay(delay)
                .SetAutoKill(false);
