...
{
    [NodeMenuDisplay("Tweens/UI/Layout Element/Min Size")]
    public class LayoutElementMinSizeVertex : TweenVertex
    {
        [SerializeField]
        ...
        public override Tween GenerateTween()
        {
            ...
            _value = new Vector2(target.minWidth, target.minHeight);
            ...
            Tween tween = target
                .DOMinSize(end, duration, snapping)
                .From(start)
                .SetDelay(delay)
                .SetAutoKill(false);
            SetEase(tween);
        ...
        {
            LayoutElement target = GetTarget<LayoutElement>(DefaultTarget);
            target.minWidth = _value.x;
            target.minHeight = _value.y;
        }
    }
}
