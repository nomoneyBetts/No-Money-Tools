...
{
    [NodeMenuDisplay("Tweens/UI/Layout Element/Flexible Size")]
    public class LayoutElementFlexSizeVertex : TweenVertex
    {
        [SerializeField]
        ...
        public override Tween GenerateTween()
        {
            ...
            _value = new Vector2(target.flexibleWidth, target.flexibleHeight);
            ...
            Tween tween = target
                .DOFlexibleSize(end, duration, snapping)
                .From(start)
                .SetDelay(delay)
                .SetAutoKill(false);
        ...
        {
            LayoutElement target = GetTarget<LayoutElement>(DefaultTarget);
            target.flexibleWidth = _value.x;
            target.flexibleHeight = _value.y;
        }
    }
}
