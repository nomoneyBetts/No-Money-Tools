...
{
    [NodeMenuDisplay("Tweens/Camera/Near Clip Plane")]
    public class CameraNearClipPlaneVertex : TweenVertex
    {
        [SerializeField]
        ...
        public override Tween GenerateTween()
        {
            ...
            Tween tween = target
                .DONearClipPlane(end, duration)
                .From(start)
                .SetDelay(delay)
                .SetAutoKill(false);
            SetEaseAndLoops(tween);
            SetEvents(tween);
            target.nearClipPlane = _value;
