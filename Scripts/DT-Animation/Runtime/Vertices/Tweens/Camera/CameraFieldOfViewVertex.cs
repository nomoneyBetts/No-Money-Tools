...
{
    [NodeMenuDisplay("Tweens/Camera/Field of View")]
    public class CameraFieldOfViewVertex : TweenVertex
    {
        [SerializeField]
        ...
        public override Tween GenerateTween()
        {
            ...
            Tween tween = target
                .DOFieldOfView(end, duration)
                .From(start)
                .SetDelay(delay)
                .SetAutoKill(false);
            SetEaseAndLoops(tween);
            SetEvents(tween);
            target.fieldOfView = _value;
