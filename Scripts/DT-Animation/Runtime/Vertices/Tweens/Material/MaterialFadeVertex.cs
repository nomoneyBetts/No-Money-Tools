...
{
    [NodeMenuDisplay("Tweens/Material/Fade")]
    public class MaterialFadeVertex : TweenVertex
    {
        [SerializeField]
        ...
        public override Tween GenerateTween()
        {
            ...
            float alpha = _value[index].color.a;
            float start = _startCnx == null ? alpha : ((ValueVertex<float>)_startCnx.TargetCnx).Value;
            float end = _endCnx == null ? alpha : ((ValueVertex<float>)_endCnx.TargetCnx).Value;
            ...
            if (_propNameCnx == null)
            {
                ...
                else
                {
                    ...
                    tween = _value[index]
                        .DOFade(end, ((ValueVertex<int>)_propIdCnx.TargetCnx).Value, duration)
                        .From(start);
                }
            }
            else
            {
                ...
                tween = _value[index]
                    .DOFade(end, ((ValueVertex<string>)_propNameCnx.TargetCnx).Value, duration)
                    .From(start);
            }
