...
{
    [NodeMenuDisplay("Tweens/Material/Blendable Color")]
    public class MaterialBlendableColorVertex : TweenVertex
    {
        [SerializeField]
        private Connection _endCnx, _matIndexCnx, _propNameCnx, _propIdCnx;
        ...
        { 
            ...
            if (propstr == null)
            {
                if (_propIdCnx == null)
                {
                    Color color = _value[index].color;
                    Color end = _endCnx == null ? color : ((ValueVertex<Color>)_endCnx.TargetCnx).Value;
                    tween = _value[index]
                ...
                else
                {
                    ...
                    Color color = _value[index].GetColor(propid);
                    Color end = _endCnx == null ? color : ((ValueVertex<Color>)_endCnx.TargetCnx).Value;
                    tween = _value[index]
            ...
            {
                Color color = _value[index].GetColor(propstr);
                Color end = _endCnx == null ? color : ((ValueVertex<Color>)_endCnx.TargetCnx).Value;
                tween = _value[index]
