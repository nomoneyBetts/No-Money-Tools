...
{
    [NodeMenuDisplay("Tweens/Audio/Fade Source")]
    public class AudioSourceFadeVertex : TweenVertex
    {
        [SerializeField]
        ...
        {
            AudioSource target = GetTarget<AudioSource>(DefaultTarget);
            _value = target.volume;
