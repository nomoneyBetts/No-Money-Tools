...
{
    [NodeMenuDisplay("Tweens/Sprite Renderer/Color")]
    public class SpriteColorVertex : TweenVertex
    {
        [SerializeField]
        ...
        public override Tween GenerateTween()
        {
            ...
            Color end = _startCnx == null ? _value : ((ValueVertex<Color>)_endCnx.TargetCnx).Value;
